...
(define (DrawPiezes positions counter turn jaqueState lPieze lIndex)
    ...
    (if (< counter 63)
        (DrawPiezes mainPosition (+ counter 1) turn jaqueState lPieze lIndex)
        (begin
            (if (= (DetectJaque positions lPieze lIndex turn) 1)
...
(define (DetectJaque positions piezeV indexV turn)
    ...
    (define whitePiezes "-tcaryp")
    (if (equal? piezeV #\t)
        (if (MoveTorreAndQueen positions posKing indexV #\v (remainder indexV 8) (remainder posKing 8) (quotient indexV 8) (quotient posKing 8) turn blackPiezes 0)
            (+ 0 1)
            (+ 0 0)
        )
        (if (equal? (~a piezeV) "r")
            (if (MoveTorreAndQueen positions posKing indexV #\v (remainder indexV 8) (remainder posKing 8) (quotient indexV 8) (quotient posKing 8) turn blackPiezes 0)
                (+ 0 1)
                (if (MoveAlfilAndQueen positions posKing indexV #\v (remainder indexV 8) (remainder posKing 8) (quotient indexV 8) (quotient posKing 8) turn blackPiezes 0)
                    (+ 0 1)
                    (+ 0 0)
                )
            )
            (if (equal? piezeV "a")
                ...
                (if (equal? piezeV "c")
                    (if (MoveHorse positions posKing indexV #\v (remainder indexV 8) (remainder posKing 8) (quotient indexV 8) (quotient posKing 8) turn blackPiezes 0)
                        (+ 0 1)
                        (+ 0 0)
                    )
                    (if (equal? piezeV #\p)
                        (if (MovePeon positions posKing indexV #\v (remainder indexV 8) (remainder posKing 8) (quotient indexV 8) (quotient posKing 8) turn blackPiezes 0)
                            (+ 0 1)
                            (+ 0 0)
                        )
                        (if (equal? (~a piezeV) "R")
                            (if (MoveTorreAndQueen positions posKing indexV #\v (remainder indexV 8) (remainder posKing 8) (quotient indexV 8) (quotient posKing 8) turn whitePiezes 0)
                                (+ 0 1)
                                (if (MoveAlfilAndQueen positions posKing indexV #\v (remainder indexV 8) (remainder posKing 8) (quotient indexV 8) (quotient posKing 8) turn whitePiezes 0)
                                    (+ 0 1)
                                    (+ 0 0)
                                )
                            )
                            (if (equal? piezeV "C")
                                (if (MoveHorse positions posKing indexV #\v (remainder indexV 8) (remainder posKing 8) (quotient indexV 8) (quotient posKing 8) turn whitePiezes 0)
                                    (+ 0 1)
                                    (+ 0 0)
                                )
                                (+ 0 0)
...
;(DrawPiezes "-t--YACTPPPPPPPP--------------------------------pppppppptcaryact" 0 0 0 #\t 0)
(DrawPiezes "TCARYACTPPPP-PPP--------------------------------pppp-ppptcaryact" 0 0 0 #\t 0)
